        ...
        <div className="flex space-x-1 border-t border-slate-800/60 pt-2 pb-2.5 overflow-x-auto no-scrollbar">
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-xs font-semibold tracking-wide transition-colors duration-150 cursor-pointer focus:outline-none border ${
              activeTab === 'earnings'
                ? 'bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/40 shadow-sm shadow-cyan-500/10'
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-xs font-semibold tracking-wide transition-colors duration-150 cursor-pointer focus:outline-none border ${
              activeTab === 'portfolio'
                ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-300 border-emerald-500/40 shadow-sm shadow-emerald-500/10'
                : 'text-slate-400 hover:text-slate-200 hover:bg-slate-900/60 border-transparent'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-xs font-semibold tracking-wide transition-colors duration-150 cursor-pointer focus:outline-none border ${
              activeTab === 'advisor'
                ? 'bg-gradient-to-r from-violet-500/20 to-purple-500/20 text-violet-300 border-violet-500/40 shadow-sm shadow-violet-500/10'
                : 'text-slate-400 hover:text-slate-200 hover:bg-slate-900/60 border-transparent'
            }`}
          >
